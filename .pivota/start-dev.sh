...
# === Pre-exec snippet: allowedDevOrigins overlay + best-effort migration ===
...
// Auto-generated by pivota init-dev-server.
...
# Best-effort schema migration on platform-provided-DB backends:
